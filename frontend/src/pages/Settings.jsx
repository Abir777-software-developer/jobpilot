  ...
  return (
    <div className="max-w-[800px] mx-auto">
      <header className="mb-lg">
        ...
        <p className="text-on-surface-variant">Manage your professional profile and application preferences.</p>
      </header>

      <section className="bg-surface-container-lowest rounded-lg organic-shadow p-md mb-gutter">
        <h3 className="font-headline-md text-headline-md text-primary mb-6">Profile Information</h3>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
            <div className="space-y-2 group">
              <label className="font-label-md text-on-surface-variant group-focus-within:text-primary transition-colors">Full Name</label>
              <input 
            ...
            <div className="space-y-2 group">
              <label className="font-label-md text-on-surface-variant group-focus-within:text-primary transition-colors">Email Address</label>
              <input 
                className="w-full px-4 py-3 rounded-lg bg-surface border border-outline-variant/20 focus:border-primary focus:ring-0 transition-colors outline-none font-body-md" 
                type="email" 
                defaultValue="" 
      ...
      <section className="bg-surface-container-lowest rounded-lg organic-shadow p-md mb-gutter">
        <div className="flex items-center justify-between mb-6">
          <h3 className="font-headline-md text-headline-md text-primary">Resume & Documents</h3>
        ...
        <div className="border-2 border-dashed border-outline-variant/30 rounded-lg p-lg text-center bg-surface-container-low/50">
          <span className="material-symbols-outlined text-outline text-[48px] mb-4">upload_file</span>
          <p className="text-on-surface font-label-md mb-1">Your resume: <span className="font-bold">No file uploaded</span></p>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between gap-gutter mt-lg pt-lg border-t border-outline-variant/20">
        <div>
          ...
          <p className="text-label-sm text-outline">Manage your current login session and security settings.</p>
        </div>
        <button className="px-8 py-2.5 rounded-lg border border-primary text-primary font-label-md hover:bg-surface-container-high transition-colors active:scale-95 flex items-center gap-2">
