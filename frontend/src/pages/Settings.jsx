        ...
        <div className="border-2 border-dashed border-outline-variant/30 rounded-lg p-lg text-center bg-surface-container-low/50">
          ...
          <p className="text-on-surface font-label-md mb-1">
            ...
            <span className="font-bold">
              {user?.profile?.rawResumeText ? "Uploaded" : "No file uploaded"}
            </span>
          </p>
          ...
          <button
            ...
            className="bg-primary text-on-primary px-6 py-2.5 rounded-lg font-label-md hover:opacity-90 transition-opacity active:scale-95 inline-flex items-center gap-2"
          >
