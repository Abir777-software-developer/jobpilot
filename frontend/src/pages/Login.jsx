      ...
      <main className="w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="text-center mb-lg">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-primary-container rounded-xl mb-md organic-shadow">
            <span className="material-symbols-outlined text-on-primary text-[32px]">flight_takeoff</span>
          </div>
          <h1 className="font-headline-xl text-headline-xl text-primary tracking-tight mb-xs">JobPilot</h1>
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-[280px] mx-auto">Your AI co-pilot for job applications</p>
        </div>
        ...
        >
          <div className="space-y-md">
            <button className="w-full h-14 bg-primary-container text-on-primary font-label-md text-label-md rounded-lg flex items-center justify-center gap-sm transition-all duration-300 hover:opacity-90 active:scale-[0.98]">
            ...
            <div className="relative flex items-center py-sm">
              ...
              <span className="flex-shrink mx-md font-label-sm text-label-sm text-outline uppercase tracking-widest">or</span>
              <div className="flex-grow border-t border-outline-variant/30"></div>
            </div>

            <div className="space-y-base">
              <label className="block font-label-sm text-label-sm text-on-surface-variant ml-xs">Professional Email</label>
              <input 
            ...
            <Link to="/" className="w-full h-12 flex items-center justify-center border border-primary text-primary font-label-md text-label-md rounded-lg hover:bg-surface-container transition-colors duration-200">
              Sign in with email
            </Link>
          </div>
          ...
          <div className="mt-lg pt-md border-t border-outline-variant/10 text-center">
            <p className="font-label-sm text-label-sm text-on-surface-variant">
              Don't have an account? <a className="text-primary font-bold hover:underline" href="#">Request early access</a>
            </p>
          </div>
        </section>
        ...
        <div className="mt-xl flex flex-col items-center gap-md">
          <div className="w-full h-32 rounded-xl bg-surface-variant overflow-hidden organic-shadow relative flex items-center justify-center">
             <span className="material-symbols-outlined text-outline text-[48px] opacity-20">landscape</span>
