...
const navItems = [
  ...
  { name: 'Cover Letter Generator', path: '/cover-letter-review', icon: 'edit_note' },
  ...
  return (
    <aside className="flex flex-col h-full border-r border-outline-variant/10 w-64 fixed left-0 top-0 bg-surface dark:bg-surface-container shadow-sm z-50">
      <div className="px-md py-lg">
        <h1 className="text-headline-md font-headline-md font-bold text-primary dark:text-primary-fixed">JobPilot</h1>
        <p className="text-label-sm text-on-surface-variant/60 tracking-wider">ELEVATED UTILITY</p>
      </div>
      ...
      <div className="p-md mt-auto">
        <div className="mt-md flex items-center space-x-sm p-sm">
          <div className="w-8 h-8 rounded-full bg-primary-container text-on-primary-container flex items-center justify-center overflow-hidden">
             {/* Placeholder for user avatar - removing dummy image */}
             <span className="material-symbols-outlined text-[16px]">person</span>
          </div>
          <div className="flex flex-col">
            <span className="text-label-sm font-bold">User Name</span>
            <span className="text-[10px] text-on-surface-variant/60">Profession</span>
          </div>
        </div>
      </div>
    </aside>
